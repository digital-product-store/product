...
books = sqlalchemy.Table(
    ...
    metadata,
    sqlalchemy.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
    sqlalchemy.Column("upload_id", postgresql.UUID, sqlalchemy.ForeignKey("uploads.id"), nullable=False),
...
async def upload_file(file: UploadFile):
    ...
    query = uploads.insert().values(id = upload_id, object_id = object_id, original_name = file.filename)
